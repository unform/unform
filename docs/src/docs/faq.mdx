...
- ### **Does Unform supports React Native?**
...
- ### **Does Unform includes it's own components like input, select, etc?**

No! Unform doesn't includes it's own components anymore, instead, you can integrate unform with any input source using the [useField](/recipes/creating-your-own-inputs) API.

- ### **Does Unform provides an easy way to access form data, errors and methods?**
...
- ### **Does Unform integrates with Yup or other validation libraries?**
